...
public class GZIPFileArray extends FileArray {
  ...
  protected void write(int[] array) throws IOException {
    write(array, new GZIPOutputStream(new BufferedOutputStream(new FileOutputStream(filePathName))));
  }

  @Override
  protected int[] read() throws IOException {
    return read(new GZIPInputStream(new BufferedInputStream(new FileInputStream(filePathName))));
  }
}